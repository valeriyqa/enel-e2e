...
Scenario: B2B_UDP_ Test UDP and API First authorization
	When I send UDP package with status "Standby" to unit "0817091001030440559118248497"
	Then UDP response should contain "A00"
	When I send authorization API request to terminal "0000512174600777"
	Then API response should be successful
	Then I wait till UDP package with status "Connected" returns "A40"
	When I send UDP package with status "Charging" to unit "0817091001030440559118248497"
	...
	And property "energy" should be "2000"


#@b2b @udp
#Scenario: B2B_UDP_ Test UDP and API First authorization
#	When I send UDP package with status "Standby" to unit "0817011001020457542118246997"
#	Then UDP response should contain "A00"
#	When I send authorization API request to terminal "0000512174600755"
#	Then API response should be successful
#	Given I wait till UDP package with status "Connected" returns "A40"
#	#When I send UDP package with status "Connected" to unit "0817011001020457542118246997"
#	#Then UDP response should cntain "A00"
#	When I send UDP package with status "Charging" to unit "0817011001020457542118246997"
#	Then UDP response should contain "A40"
#	When I send UDP package with status "Charging" to unit "0817011001020457542118246997"
#	Then UDP response should contain "A40"
#	When I send UDP package with status "Charging" to unit "0817011001020457542118246997"
...
#	When I send UDP package with status "Charging" to unit "0817011001020457542118246997"
#	Then UDP response should contain "A40"
#	Given I wait till UDP package with status "Standby" returns "A00"
#	#When I send UDP package with status "Standby" to unit "0817011001020457542118246997"
#	#Then UDP response should contain "A00"
#	When I verify device status via API request
#	Then property "status" should be "finished"
...
Scenario: B2B_UDP_ Test UDP and API First plug
	...
	Then UDP response should contain "A00"
	When I verify device status via API request
	#Then status should be "finished"
