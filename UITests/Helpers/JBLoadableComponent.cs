...
namespace UITests.Helpers
{
    ...
    /// </remarks>
    public abstract class OTALoadableComponent<T> : ILoadableComponent
        where T : OTALoadableComponent<T>
    {
        /// <summary>
        ...
        public virtual T Load()
        {
            ...
            if (!IsLoaded)
            {
                ...
                test.Error("LoadableComponentException caught during page load: " + UnableToLoadMessage,
